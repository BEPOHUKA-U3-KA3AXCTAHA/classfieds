"""Alembic env: hooks our async engine + Base.metadata, with all module ORM tables registered.

Each module's adapters/orm.py is imported here so its tables land on Base.metadata.
"""
import asyncio
...
# Register every module's ORM tables on Base.metadata.
