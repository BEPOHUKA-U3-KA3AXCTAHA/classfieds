...
# Реальные публичные TG-каналы черногорских барахолок (русскоязычные).
# Имена каналов могут меняться — отредактируй список под актуальные.
MONTENEGRO_TG_CHANNELS = [
    ("baraholka_montenegro", "Барахолка Черногории"),
    ("cg_baraholka", "Черногория Барахолка"),
    ("montenegro_buy_sell", "Montenegro Buy/Sell"),
    ("budva_baraholka", "Будва Барахолка"),
    ("podgorica_market", "Подгорица Маркет"),
    ("bar_kotor_baraholka", "Бар-Котор Барахолка"),
    ("tivat_market", "Тиват Маркет"),
]
